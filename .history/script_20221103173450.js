...
$( "#panels" ).accordion({
  ...
  var listaContainer = document.querySelector('#panels')
  var lista = document.querySelector('.oi')
  listaContainer.addEventListener('click',ativo() )
function ativo(){
lista.classList.toggle('teste-duvida')
}