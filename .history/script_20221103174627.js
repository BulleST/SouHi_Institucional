...
document.querySelector('.oi').addEventListener('click', function(){
    document.querySelector("body").setAttribute('class', '')
})

var testeDuvida = document.querySelectorAll('.oi');
testeDuvida.addEventListener('click', function(){
    testeDuvida.classList.toggle('teste-duvida')
})