...
var containerDuvida = document.querySelector('duvida-aberta')
    btn.addEventListener('click', function(){
        if(containerDuvida.style.display==='block'){
            containerDuvida.style.display= 'none'
        }
        else{
            containerDuvida.style.display ='block'
        }
    })
